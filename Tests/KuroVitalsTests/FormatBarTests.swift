...
final class FormatBarTests: XCTestCase {
    func testAllFields() {
        let s = Snapshot(cpuTempC: 48.4, cpuLoadPct: 12.6, ramUsedGB: 9.13, ramTotalGB: 16,
                         fans: [FanReading(index: 0, rpm: 2400, min: 1800, max: 6000, forced: false)])
    ...
    func testSubsetFields() {
        let s = Snapshot(cpuTempC: 50, cpuLoadPct: 5, ramUsedGB: 8, ramTotalGB: 16,
                         fans: [FanReading(index: 0, rpm: 2000, min: 1800, max: 6000, forced: false)])
